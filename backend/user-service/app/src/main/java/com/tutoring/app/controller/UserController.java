...
import com.tutoring.app.dto.UpdateUsernameRequest;
...
public class UserController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<?> updateUsername(@PathVariable UUID id, @Valid @RequestBody UpdateUsernameRequest request) {
