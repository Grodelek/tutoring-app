...
public class OfferResponseDTO {
  ...
  public OfferResponseDTO(TutorOffer offer) {
    ...
    if (offer.getLesson() != null) {
      ...
      l.setId(offer.getLesson().getId());
      l.setSubject(offer.getLesson().getSubject());
      l.setDescription(offer.getLesson().getDescription());
      l.setDurationTime(offer.getLesson().getDurationTime());
      l.setPrice(offer.getLesson().getPrice());
      if (offer.getLesson().getTutor() != null) {
        l.setTutorId(offer.getLesson().getTutor().getId());
      }
      this.lesson = l;
    }
  }
